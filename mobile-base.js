...
var init = function (onSelectFeatureFunction) {
    ...
    map = new OpenLayers.Map({
		...
		maxExtent: new OpenLayers.Bounds(-43.9621,-19.9431, -43.9349, -19.9229),
		//restrictedExtent: new OpenLayers.Bounds(-43.9621,-19.9431, -43.9349, -19.9229),
        layers: [
            new OpenLayers.Layer.OSM("Local Tiles", "tiles/${z}/${x}/${y}.png", "tiles/${z}/${x}/${y}.png", {numZoomLevels: 17, alpha: true, isBaseLayer: true}),
